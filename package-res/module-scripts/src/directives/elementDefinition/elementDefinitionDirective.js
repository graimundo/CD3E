...
define( [ 'cd3e' ],
        function ( app ) {
            app.directive('elementDefinition', function() {
                return {
                    ...
                    templateUrl: 'src/directives/elementDefinition/elementDefinitionTemplate.html',
                    controller: 'elementDefinitionController',
                    //isolate scope
                    scope: {
